...
try {
	...
	$client = new WC_API_Client( 'https://temp-test-stoned-code-warrior.c9users.io', 'ck_a6906166ec4ad787bc54095f1c4bd349b64ec417', 'cs_4126f99c7e5887c46e8d971609368d7b63c2b26c', $options );
	...
	// products
	print_r( $client->products->get() ); //it worked
